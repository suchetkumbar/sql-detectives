...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Solve cinematic murder mysteries by writing real SQL. Beginner to advanced cases with story chapters and rapid-fire interrogations." },
      { property: "og:title", content: "Coldcase SQL — Detective Mystery Game" },
      { property: "og:description", content: "Solve cinematic murder mysteries by writing real SQL." },
